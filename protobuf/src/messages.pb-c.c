...
static const ProtobufCFieldDescriptor messages__client_request__field_descriptors[3] =
{
  {
    "type",
    1,
...
static const ProtobufCFieldDescriptor messages__client_response__field_descriptors[3] =
{
  {
    "type",
    1,
...
const ProtobufCEnumValue messages__type__enum_values_by_number[2] =
{
...
const ProtobufCEnumValueIndex messages__type__enum_values_by_name[2] =
{
  { "GET", 0 },
  { "PUT", 1 },
};
